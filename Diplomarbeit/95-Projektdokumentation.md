...
* Der Antrag für die Diplomarbeit wurde pünkltlich eingereicht.
...
#### Nächste Schritte
* Erstellung von funktionalen Mockups
* Technologie Stack für Front und Backendfestlegen
...
#### Gesamtstatus: im Plan
* Das Projekt befindet sich derzeit im Plan.
* Recherche über diverse Infopoint Lösungen wurde durchgeführt und dokumentiert.
...
* Erstellung von funktionalen Mockups
* Technologie Stack für Front und Backend festlegen
...
* Das Projekt befindet sich derzeit im Plan.
* Funktionale Mockups wurden erstellt und der Technologie Stack festgelegt.
...
#### Nächste Schritte
* Beginn der Implementierungsphase für Frontend und Backend
...
#### Gesamtstatus: im Plan
* Das Projekt befindet sich derzeit im Plan.
* Die Implementierungsphase für die Rohversion von Frontend und Backend wurde abgeschlossen.
...
#### Gesamtstatus: leicht verzögert
* Das Projekt ist leicht verzögert aufgrund von unvorhergesehenen Schwierigkeiten bei der Anbindung des CMS Systems.

| Dimension           | Status            |  Maßnahmen
|:--------------------|:------------------|:---------------------------------------------|
| Leistungsziele      | leicht verzögert  | zusätzliche Zeit für CMS Anbindung einplanen |
| Terminziele         | leicht verzögert  | Zeitplan anpassen                            |
| Kostenziele         | In Ordnung        | keine                                        |
| Teamarbeit          | optimal           | keine                                        |

:Projektstatus am 2025-10-20
...
#### Nächste Schritte
* Fertigstellung der CMS Anbindung
* Vereinigung von Frontend und Backend
...
* Das Projekt ist verzögert aufgrund von Schwierigkeiten bei der Anbindung des CMS Systems.

| Dimension           | Status            |  Maßnahmen
|:--------------------|:------------------|:---------------------------------------------|
| Leistungsziele      | verzögert         | zusätzliche Zeit für CMS Anbindung einplanen |
| Terminziele         | verzögert         | Zeitplan anpassen                            |
| Kostenziele         | In Ordnung        | keine                                        |
| Teamarbeit          | optimal           | keine                                        |

:Projektstatus am 2025-10-27
...
#### Nächste Schritte
* Fertigstellung der Vereinigung von Frontend und Backend
* Vorbereitung auf die 1. Zwischenpräsentation
